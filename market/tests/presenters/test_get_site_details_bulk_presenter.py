...
class TestGetSiteDetailsBulkPresenter:
    ...
    def test_get_site_details_bulk_response(
        self, presenter, site_dtos, owner_dtos, response_get_site_details_bulk
    ):
        # Arrange

        # Act
        response = presenter.get_sites_bulk_response(
            site_dto_list=site_dtos, owner_dto_list=owner_dtos
        )
