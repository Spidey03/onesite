...
class TestGetSiteDetailsInteractor:
    ...
    def interactor(self, user_storage, site_storage):
        from market.interactors.get_site_details \
            import GetSiteInteractor
    ...
    def test_raise_site_not_found_exception(
            self, interactor, site_storage,
            user_storage, presenter
    ):
        # Arrange
    ...
    def test_raise_user_not_found_exception(
            self, interactor, site_storage,
            user_storage, presenter, site_dto
    ):
        # Arrange
    ...
    def test_success_response(
        ...
        expected_response = Mock()
        presenter.get_site_details_response. \
            return_value = expected_response
