...
class TestGetSiteDetailsBulkInteractor:
    ...
    def interactor(self, site_storage, user_storage):
        from market.interactors.get_site_details_bulk import (
            GetSiteDetailsBulkInteractor,
        )
    ...
    def site_dto_list(self):
        ...
        return SiteDTOFactory.create_batch(size=3, owner_id=factory.Iterator(USER_IDS))
    ...
    def owner_dto_list(self):
        ...
        return UserDetailsDTOFactory.create_batch(
            size=len(list(set(USER_IDS))), id=factory.Iterator(list(set(USER_IDS)))
        )
    ...
    def test_returns_response(
        ...
        user_storage.get_users_bulk.assert_called_once_with(
