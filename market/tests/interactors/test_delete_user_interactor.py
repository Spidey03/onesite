...
class TestGetSiteDetailsBulkInteractor:
    ...
    def interactor(self, user_storage):
        ...
        return DeleteUserInteractor(user_storage=user_storage)
    ...
    def test_user_not_found_exception(self, user_storage, presenter, interactor):
        # Arrange
        ...
        # Act
        interactor.delete_user_wrapper(user_id=user_id, presenter=presenter)
    ...
    def test_success_response(self, user_storage, presenter, interactor):
        # Arrange
        user_id = 'd32b2f96-93f5-4e2f-842d-d590783dc%03d1'
