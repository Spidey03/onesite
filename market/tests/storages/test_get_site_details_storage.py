...
class TestGetSiteDetails:
    ...
    @pytest.mark.django_db
    def test_get_site_details(self, storage, site_db, site_dto):
        # Arrange
        site_id = "d32b2f96-93f5-4e2f-842d-d590783dd001"
        expected_site_dto = site_dto

        # Act
        actual_site_dto = storage.get_site_details(site_id=site_id)

        # Assert
        assert actual_site_dto == expected_site_dto
