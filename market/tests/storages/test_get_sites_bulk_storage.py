...
class TestGetSitesBulkStorage:
    ...
    def sites_objs(self):
        ...
        SiteModelFactory.create_batch(
            size=3, is_private=False, price=3000.0, type='Site', availability=True
        )
        SiteModelFactory.create(
            is_private=True, availability=True, type='Site', price=100.0
        )
        SiteModelFactory.create(
            is_private=False, availability=False, type='Home', price=200.0
        )
    ...
    def site_dto_list(self):
        ...
        site_dtos = SiteDTOFactory.create_batch(
            size=3, is_private=False, price=3000.0, type='Site', availability=True
        )
        site_dtos.append(
